...
#include "dist.hh"
template<class X> class MwRef;
template<class X> class SwRef;
class PRADSStat;
class Connection;
class Asset;
...
#define ISSET_CXT_DONT_CHECK_CLIENT(check)  (check & CXT_DONT_CHECK_CLIENT)
#define ISSET_CXT_DONT_CHECK_SERVER(check)  (check & CXT_DONT_CHECK_SERVER)
#define ISSET_DONT_CHECK_SERVICE(check)     (check & CXT_SERVICE_DONT_CHECK)
#define ISSET_DONT_CHECK_CLIENT(check)      (check & CXT_CLIENT_DONT_CHECK)
#define ISSET_SERVICE_UNKNOWN(check)        (check & CXT_SERVICE_UNKNOWN_SET)
#define ISSET_CLIENT_UNKNOWN(check)         (check & CXT_CLIENT_UNKNOWN_SET)
...
typedef struct _packetinfo {
	...
	SwRef<Connection> cxt;		/* pointer to the cxt for this packet */
    MwRef<Asset> asset;         /* pointer to the asset for this (src) packet */
